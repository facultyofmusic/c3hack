...
public class OneInternalConsole implements ComponentListener{
	/**
	 ...
	 */
	private static OneInternalConsole instance;
	 ...
	 * @param app
	 */
	private OneInternalConsole(GameContainer container, OneApp app){
		this.app = app;
	 ...
	 * @return
	 */
	public static OneInternalConsole getInstance(GameContainer container, OneApp app){
		if (instance == null){
			instance = new OneInternalConsole(container, app);
		}
		return instance;
	}
	...
	public void render(GameContainer container, Graphics g){
		...
		g.drawString("L.A.N.E.X  -  TH121 Console  -  FPS: " + OneApp.app.getFPS(), 5, 3);
	}
